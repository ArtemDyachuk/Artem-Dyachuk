...
export async function POST(request: Request) {
  ...
  try {
    ...
    // HubSpot rejects submissions if context fields are included but not configured as form fields
    // Keep payload minimal - only fields array to ensure submissions work reliably
    const payload = {
      fields,
    };
